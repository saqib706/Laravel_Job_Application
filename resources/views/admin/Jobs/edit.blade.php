                        ...
                        <div class="card-body card-form p-4">
                            ...
                            <div class="row">
                                    ...
                                    <select class="form-select" name="jobType" id="jobType">
                                        ...
                                        @if ($jobtypes->isNotEmpty())
                                            @foreach ($jobtypes as $jobtype)
                                                <option value="{{ $jobtype->id }}" {{ $jobtype->id == $job->job_types_id ? 'selected': '' }}>{{ $jobtype->name }}</option>
                                            @endforeach
                                        @endif
                                    </select>
                                    <p></p>
                                ...
                                <div class="col-md-6  mb-4">
                                    ...
                                    <input value="{{ $job->vacancy_count}}" type="number" min="1" placeholder="Vacancy" id="vacancy" name="vacancy" class="form-control">
                                    <p></p>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="mb-4 col-md-6">
                                    ...
                                    <div class="form-check-inline">
                                        <input {{ ($job->status == 0) ? 'checked' : '' }}  class="form-check-input" type="radio" value="1" name="status" id="status-block">
                                        <label class="form-check-label" for="status">
                                        Block
                                        </label>
                                    </div>
                            ...
                            <div class="mb-4">
                                <label for="" class="mb-2">Experienece <span class="req">*</span></label>
